...
VAE_MODELS=(
"https://huggingface.co/Kijai/flux-fp8/resolve/main/ae.safetensors"
)
...
CONTROLNET_MODELS=(
    "https://huggingface.co/XLabs-AI/flux-controlnet-canny/resolve/main/flux-controlnet-canny.safetensors"
